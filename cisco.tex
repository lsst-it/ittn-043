...
Our actual data center network is based on Cisco hardware and ACI-oriented.

The following image is a summary of summit and base actual ACI infrastructure:
...
\begin{figure}
    \includegraphics[width=15cm]{images/images/fy21-rubin-network.jpg}
    \centering
